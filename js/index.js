...
function calculateBMI() {
    ...
    if (bmi < 18.5) {
        ...
        explanation = "Individu dengan BMI di bawah 18,5 dianggap Kurus (Underweight), yang dapat diindikasikan kekurangan gizi, masalah kesehatan yang mendasarinya, atau praktik penurunan berat badan yang tidak sehat."
